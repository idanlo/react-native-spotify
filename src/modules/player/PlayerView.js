        ...
        <LinearGradient
          ...
          <View style={{paddingTop: StatusBar.currentHeight + 50}}>
            <View style={styles.header}>
              ...
              <View style={{flex: 1}}>
                <Text numberOfLines={1} bold style={{textAlign: 'center'}}>
            ...
            <View style={styles.body}>
              ...
              <View style={styles.songDetails}>
                ...
                <View
                  ...
                  <TouchableOpacity>
                    <Icon name="ios-heart" color="#1DB954" size={25} />
                  </TouchableOpacity>
                </View>
              </View>
              <View style={styles.slider}>
                ...
                <Text
                  ...
                  {this.prettifySeconds(this.props.currentTrack.duration)}
                </Text>
                <Slider
              ...
              <View style={styles.buttons}>
                <TouchableOpacity
                  onPress={() =>
                    Spotify.setShuffling(!this.props.state.shuffling)
                  }
                  style={styles.sideBtn}>
                  <Icon
                    name="ios-shuffle"
                    color={this.props.state.shuffling ? '#1DB954' : '#fff'}
                    size={25}
                  />
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  <Icon
                    ...
                    color={this.props.prevTrack ? '#fff' : 'grey'}
                    size={40}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  ...
                  {this.props.state.playing ? (
                    <Icon name="ios-pause" size={70} color="#fff" />
                  ) : (
                    <Icon name="ios-play" size={70} color="#fff" />
                  )}
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  <Icon
                    ...
                    color={this.props.nextTrack ? '#fff' : 'grey'}
                    size={40}
                  />
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  onPress={() =>
                    Spotify.setRepeating(!this.props.state.repeating)
                  }
                  style={styles.sideBtn}>
                  <Icon
                    name="ios-repeat"
                    color={this.props.state.repeating ? '#1DB954' : '#fff'}
                    size={25}
                  />
                </TouchableOpacity>
              </View>
