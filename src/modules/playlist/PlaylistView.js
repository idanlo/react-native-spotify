                    ...
                    this.props.showModal(
                      {
                        ...
                        primaryText: this.state.playlist.name,
                        secondaryText: `Playlist by ${this.state.playlist.owner.display_name}`,
                      },
                      [
                        {
                          text: 'Follow',
                          click: () =>
                            Spotify.sendRequest(
                              `v1/playlists/${this.state.playlist.id}/followers`,
                              'PUT',
                              {},
                              false,
                            ),
            ...
            <ScrollView overScrollMode="never">
              <View
                ...
                <View style={{alignItems: 'center'}}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      Spotify.playURI(this.state.playlist.uri, 0, 0)
                    }>
                    <View
                      style={{
                        alignItems: 'center',
                ...
                <FlatList
                  ...
                  renderItem={({item, index}) => (
                    <Song
                      onPress={() =>
                        Spotify.playURI(this.state.playlist.uri, index, 0)
                      }
                      color={
                        this.props.currentTrack &&
                        this.props.currentTrack.uri === item.track.uri &&
